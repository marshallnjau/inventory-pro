...
export function Settings() {
  const { user } = useAuth();
  const { profile, company, updateProfile, updateCompany, loading } = useSettings();
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="p-6 bg-slate-50 border border-slate-200 rounded-2xl space-y-4">
                    <div className="flex items-center gap-3">
                       ...
                       <div>
                          <h4 className="font-bold text-slate-900 text-sm">Sample Data Seeding</h4>
                          <p className="text-xs text-slate-500 font-medium">Populate your app with demo products, suppliers, and customers.</p>
                       </div>
                    </div>
                    <div className="pt-2">
                       <button
                         ...
                         className={cn(
                           "w-full flex items-center justify-center gap-2 px-6 h-11 rounded-xl font-bold text-sm transition-all relative overflow-hidden",
                           seedSuccess 
                             ? "bg-emerald-600 text-white" 
